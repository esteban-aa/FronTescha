...
public class menuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!rol.equals("administrador")) {
            ...
            adapter = new UsuarioAdapter(lista, new UsuarioAdapter.OnUsuarioClickListener() {
                ...
                public void onEliminarClick(Usuario usuario) {
                    String idBackend = usuario.getIdBackend();  // Aquí debes tener el método getIdBackend()
                    usuarioDao.eliminar(usuario);               // Elimina localmente
                    eliminarUsuarioDelBackend(idBackend);       // Elimina en backend
                    recargarLista();
        ...
        // Puedes agregar aquí más listeners para otros botones si quieres
    }
